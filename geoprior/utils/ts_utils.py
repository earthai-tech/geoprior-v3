...
def resolve_time_steps(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import resolve_time_steps
    >>> data = {
    ...     'sensor_id': ['A']*10 + ['B']*15,
...
def compute_group_window_counts(
    ...
    Examples
    --------
    >>> from geoprior.utils.ts_utils import compute_group_window_counts
...
def filter_by_period(
    ...
    Examples
    --------
    >>> from geoprior.utils.ts_utils import filter_by_period
    >>> df = pd.DataFrame({
...
def to_dt(
    ...
    **kwargs
    ...
    Examples
    --------
    >>> from geoprior.utils.ts_utils import to_dt
    >>> import pandas as pd
...
def ts_validator(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import ts_validator
...
def trend_analysis(
    ...
    **kw : dict, optional
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import trend_analysis
    >>> data = {
    ...     'Date': [
...
def trend_ops(
    ...
    **kw : dict, optional
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import trend_ops
    >>> data = {
    ...     'Date': [
    ...         '2020-01-01', '2020-01-02', '2020-01-03',
    ...         '2020-01-04', '2020-01-05'
...
def visual_inspection(
    ...
    **kwargs : dict, optional
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import visual_inspection
    >>> data = {
    ...     'Date': [
...
def get_decomposition_method(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import get_decomposition_method
    >>> data = {
    ...     'Date': [
...
def infer_decomposition_method(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import infer_decomposition_method
    >>> data = {
    ...     'Date': [
    ...         '2020-01-01','2020-02-01','2020-03-01',
    ...         '2020-04-01','2020-05-01'
...
def decompose_ts(
    ...
    *seasonal* component, and :math:`R_t` is the *residual*
    ...
    >>> import numpy as np
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import decompose_ts
...
def ts_engineering(
    ...
    **kwargs : dict, optional
    ...
    >>> import pandas as pd
    >>> import numpy as np
    >>> from geoprior.utils.ts_utils import ts_engineering
...
def prepare_ts_df(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import prepare_ts_df
    >>> data = {
    ...     'Date': [
...
def ts_corr_analysis(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import ts_corr_analysis
    >>> data = {
    ...     'Date': [
    ...         '2021-01-01','2021-01-02','2021-01-03',
...
def transform_stationarity(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import transform_stationarity
    >>> data = {
    ...     'Date': [
    ...         '2021-01-01', '2021-01-02', '2021-01-03',
    ...         '2021-01-04', '2021-01-05'
...
def ts_split(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import ts_split
    >>> data = {
    ...     'Date': [
    ...         '2021-01-01','2021-01-02','2021-01-03',
    ...         '2021-01-04','2021-01-05'
...
def ts_outlier_detector(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import ts_outlier_detector
    >>> data = {
    ...     'Date': [
    ...         '2021-01-01','2021-01-02','2021-01-03',
...
def create_lag_features(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import create_lag_features
    >>> data = {
    ...     'Date': [
    ...         '2021-01-01','2021-01-02','2021-01-03',
    ...         '2021-01-04','2021-01-05'
...
def select_and_reduce_features(
    ...
    --------
    >>> import pandas as pd
    >>> from geoprior.utils.ts_utils import select_and_reduce_features
    >>> data = {
    ...     'A': [1, 2, 3, 4, 5],
    ...     'B': [2, 4, 6, 8, 10],
    ...     'C': [5, 3, 6, 2, 11],
