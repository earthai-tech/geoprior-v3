...
def type_of_target(y):
    ...
    Examples
    --------
    >>> from geoprior.compat.sklearn import type_of_target
    ...
    `geoprior.core.utils.type_of_target` : gofast's fallback implementation
    ...
    .. [2] Gofast Documentation. Available at https://geoprior.readthedocs.io/en/latest/
    ...
    try:
        ...
        try:
            ...
            raise ImportError(
                "Neither scikit-learn nor geoprior.core.utils could provide "
                "'type_of_target'. Please ensure that scikit-learn is installed "
                "or geoprior.core.utils contains 'type_of_target'."
            )
...
def validate_params(
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from geoprior.compat.sklearn import validate_params
    >>> @validate_params({
    ...     'step_name': [str],
    ...     'param_grid': [dict],
    ...     'n_trials': [int],
