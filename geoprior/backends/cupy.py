...
class CuPyBackend(BaseBackend):
    ...
    def __getattr__(self, name):
        ...
        try:
            ...
            raise AttributeError(
                f"'CuPyBackend' object has no attribute '{name}'"
            )
    ...
    def svd(self, a, full_matrices=True, compute_uv=True):
        ...
        Singular Value Decomposition on the GPU.
        """
        return self._backend.linalg.svd(
            a,
    ...
    def linalg_svd(
        self, a, full_matrices=True, compute_uv=True
    ):
        """
        Singular Value Decomposition on the GPU.
    ...
    def random_normal(self, loc=0.0, scale=1.0, size=None):
        ...
        """
        return self._backend.random.normal(
    ...
    def random_uniform(self, low=0.0, high=1.0, size=None):
        ...
        """
        return self._backend.random.uniform(
    ...
    def random_integers(self, low, high=None, size=None):
        ...
        """
        return self._backend.random.randint(
            low, high=high, size=size
        )
