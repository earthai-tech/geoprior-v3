...
def time_weighted_interval_score(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import time_weighted_interval_score
...
def time_weighted_accuracy_score(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import time_weighted_accuracy_score
...
def theils_u_score(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import theils_u_score
...
def mean_interval_width_score(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import mean_interval_width_score
...
def quantile_calibration_error(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import quantile_calibration_error
...
def time_weighted_mean_absolute_error(
    ...
    --------
    >>> import numpy as np
    >>> # from geoprior.metrics import time_weighted_mean_absolute_error
...
def coverage_score(
    ...
    Examples
    --------
    >>> from geoprior.metrics import coverage_score
    >>> import numpy as np
...
def get_scorer(scoring, include_sklearn: bool = True):
    ...
    scoring : str or callable
        - If str: look up in geoprior's SCORERS, then optionally in sklearn.
    ...
    # 2) If it's a string, first try geoprior’s registry
