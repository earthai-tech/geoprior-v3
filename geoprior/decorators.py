...
def executeWithFallback(method, *, mode="soft"):
    ...
    Examples
    --------
    >>> from geoprior.decorators import executeWithFallback
    >>> class MyClass:
    >>>     @executeWithFallback
...
class DataTransformer:
    ...
    >>> import pandas as pd
    >>> from geoprior.decorators import DataTransformer
...
class ExportData:
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from geoprior.decorators import ExportData
...
class Temp2D:
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from geoprior.decorators import Temp2D
...
class SignalFutureChange:
    ...
    Examples
    --------
    >>> from geoprior.decorators import SignalFutureChange
...
class AppendDocReferences:
    ...
    Examples
    --------
    >>> from geoprior.decorators import AppendDocReferences
...
class Deprecated:
    ...
    *instantiated* (classes), a deprecation warning is emitted that
    ...
    Examples
    --------
    >>> from geoprior.decorators import Deprecated
    >>> @Deprecated(
...
class CheckGDALData:
    ...
    Examples
    --------
    >>> from geoprior.decorators import CheckGDALData
...
class RedirectToNew:
    ...
    Examples
    --------
    >>> from geoprior.decorators import RedirectToNew
...
class PlotPrediction:
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from geoprior.decorators import PlotPrediction
...
class PlotFeatureImportance:
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from geoprior.decorators import PlotFeatureImportance
...
class AppendDocSection:
    ...
    Examples
    --------
    >>> from geoprior.decorators import AppendDocSection
...
class AppendDocFrom:
    ...
    Examples
    --------
    >>> from geoprior.decorators import AppendDocFrom
...
class IsPerformanceData:
    ...
    **kwargs : dict
    ...
    >>> from geoprior.decorators import IsPerformanceData
    >>> @IsPerformanceData
...
class NumpyDocstringFormatter:
    ...
    >>> from geoprior.decorators import NumpyDocstringFormatter
    >>> @NumpyDocstringFormatter()
