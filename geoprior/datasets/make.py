...
def make_multi_feature_time_series(
    ...
    Examples
    --------
    >>> from geoprior.datasets.make import make_multi_feature_time_series
...
def make_quantile_prediction_data(
    ...
    Examples
    --------
    >>> from geoprior.datasets import make_quantile_prediction_data
...
def make_anomaly_data(
    ...
    algorithms like :class:`~geoprior.nn.anomaly_detection.LSTMAutoencoderAnomaly`
    ...
    Returns
    -------
    data : tuple or :class:`~geoprior.api.bunch.Bunch` or pandas.DataFrame
        If ``as_frame=False`` (default):
    ...
    Examples
    --------
    >>> from geoprior.datasets import make_anomaly_data
...
def make_trend_seasonal_data(
    ...
    * 2,  # Default 2 years of daily data
    ...
    Examples
    --------
    >>> from geoprior.datasets import make_trend_seasonal_data
...
def make_multivariate_target_data(
    ...
    Examples
    --------
    >>> from geoprior.datasets import make_multivariate_target_data
