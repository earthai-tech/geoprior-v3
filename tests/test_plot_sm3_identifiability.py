    ...
    df = pd.DataFrame(
        {
            ...
            "tau_est_med_sec": [12, 14, 19, 27, 29, 36, 42, 43],
            "tau_est_med_year": [
                12 / 31556952.0,
                14 / 31556952.0,
                19 / 31556952.0,
            ...
            "K_true_mps": [1e-7, 2e-7, 4e-7, 8e-7, 1.2e-6, 1.6e-6, 2e-6, 2.4e-6],
            "K_prior_mps": [1.1e-7, 2.2e-7, 4.1e-7, 7.5e-7, 1.1e-6, 1.7e-6, 2.1e-6, 2.5e-6],
            "K_est_med_mps": [1.05e-7, 2.1e-7, 3.8e-7, 8.5e-7, 1.3e-6, 1.55e-6, 1.95e-6, 2.3e-6],
            ...
            "Ss_true": [1.0e-5] * n,
            "Ss_prior": [1.1e-5] * n,
            "Ss_est_med": [1.05e-5, 1.02e-5, 1.01e-5, 1.08e-5, 1.0e-5, 0.99e-5, 1.03e-5, 1.04e-5],
            "Hd_true": [12.0, 12.5, 13.0, 13.5, 14.0, 14.5, 15.0, 15.5],
            "Hd_prior": [12.0, 12.6, 13.1, 13.3, 14.2, 14.3, 15.1, 15.2],
            "Hd_est_med": [12.1, 12.4, 12.9, 13.6, 13.9, 14.6, 14.9, 15.6],
            "vs_true_delta_K_q50": [0.05, 0.02, -0.03, 0.04, 0.01, -0.02, 0.03, -0.01],
            "vs_true_delta_Ss_q50": [0.01, 0.02, 0.00, -0.01, 0.01, 0.00, -0.02, 0.02],
            "vs_true_delta_Hd_q50": [0.00, 0.01, -0.01, 0.00, 0.02, -0.01, 0.01, 0.00],
            "eps_prior_rms": [0.10, 0.12, 0.14, 0.11, 0.13, 0.15, 0.10, 0.12],
            "closure_consistency_rms": [0.09, 0.10, 0.11, 0.09, 0.12, 0.13, 0.10, 0.11],
        }
    )
